...
function DISCINSTR1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DISCINSTR1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function DISCINSTR2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DISCINSTR2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function DISCINSTR3RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DISCINSTR3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function DISCINSTR4RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of DISCINSTR4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function discounting_trialsLoopBegin(discounting_trialsLoopScheduler) {
  ...
  for (const thisDiscounting_trial of discounting_trials) {
...
function volle1trialsLoopBegin(volle1trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisVolle1trial of volle1trials) {
...
function volle2trialsLoopBegin(volle2trialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisVolle2trial of volle2trials) {
...
function ztrialsLoopBegin(ztrialsLoopScheduler) {
  ...
  // Schedule all the trials in the trialList:
  for (const thisZtrial of ztrials) {
...
function discountingRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of discountingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function VOLLEINSTR1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of VOLLEINSTR1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function VOLLEINSTR2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of VOLLEINSTR2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function VOLLEINSTR3RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of VOLLEINSTR3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function VOLLEPRACTICEINSTRRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of VOLLEPRACTICEINSTRComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrvolle1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrvolle1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function vollept1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of vollept1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function INTROPT2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of INTROPT2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function instrvolle2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of instrvolle2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function vollept2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of vollept2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function ZAUBINSTR1RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of ZAUBINSTR1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function ZAUBINSTR2RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of ZAUBINSTR2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function ZAUBINSTR3RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of ZAUBINSTR3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function ZAUBINSTR4RoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of ZAUBINSTR4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
...
function ZAUBTRIALSRoutineBegin(snapshot) {
  return function () {
    ...
    for (const thisComponent of ZAUBTRIALSComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    // check if the Routine should terminate
    if (!continueRoutine) {  // a component has requested a forced-end of Routine
